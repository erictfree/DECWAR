...
export function bindSetupPrefixRuntime(f:ReturnType<typeof pregameRuntimeFixture>,admission:ReturnType<typeof bindSetupAdmissionRuntime>,placement:ReturnType<typeof bindPlaceRuntime>){
  ...
  const events:string[]=diagnosticRecords(),policy:{missingTrap?:bigint;regular?:'true-first';start?:()=>Generator<string,void,void>}={},prepare=(a:bigint[])=>{loadArgumentBlock(f.m,s.header,a);selectArgumentBlock(f.r,s.header);},numeric=f.weapon.io;
