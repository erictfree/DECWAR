...
export function bindQueueInitializeRuntime(f:Host,queues:ReturnType<typeof queueState>){
  ...
  const symbols={hitql:queues.address('hitql'),msgql:queues.address('msgql'),knhit:BigInt(queueLayout.constants.knhit),knmsg:BigInt(queueLayout.constants.knmsg),hitLiteral:28400n,messageLiteral:28401n},events:string[]=diagnosticRecords();
