...
import { debugText,messages } from '../../src/generated/source-data.ts';
...
export function bindMainDebugRuntime(f:ReturnType<typeof pregameRuntimeFixture>){
  f.m.map(56000n,Array<bigint>(200).fill(77n));f.m.map(0o405562n,Array<bigint>(250).fill(0n));
  const s={pasflg:f.low.address('pasflg'),hungup:f.low.address('hungup'),unkcom:56000n,forhlp:56020n,header:56040n,newline:56060n,tab:56070n,timnam:0o405562n,timcnt:0o405562n+50n,timtot:0o405562n+100n,timhi:0o405562n+150n};
  ...
  const events:string[]=[],io:DebugRuntimeServices<string>={
