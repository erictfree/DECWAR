...
| BUILD | 7.16 | Ordered resolved eligibility; rejection/state preservation; stage limit, awards, fifth-stage conversion and final-planet latch before completion/reporting | Port-loss decisions, base insertion order, readiness and simultaneous-operation policy |
