...
| PAUSE compares raw MSTIME against its deadline without midnight correction | WARMAC.MAC:4025-4043 | A deadline beyond the largest daily clock value can cause indefinite one-second rewaits; preserved in historical diagnostic mode. Playable sessions use a monotonic private PAUSE clock; see [playable repairs](playable-decisions.md) (also Austin WARMAC.MAC:3373-3401) |
