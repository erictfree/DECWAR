// Frozen pre-training captain policy. Shared protocol/navigation remain in use.
...
export class Captain {
  ...
  choose(observation: Observation, now = Date.now()): Decision {
    ...
    const needSupplies = s.energy < 2400 || s.shieldPercent < 55 || s.hullDamage > 600 || maxDamage >= 200;
